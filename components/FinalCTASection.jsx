            ...
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
                    <Link href="/courses" passHref>
                        <motion.a className="w-full sm:w-auto py-3 px-8 text-lg font-semibold rounded-full bg-white text-gray-950 cursor-pointer" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                            Explore Courses
                        </motion.a>
                    </Link>
                </div>
