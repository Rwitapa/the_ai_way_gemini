...
// FIX: Switched from a named export to a default export.
// The runtime error "Element type is invalid" often occurs due to a mismatch
// between named and default imports. By using a default export, we create a
// single, unambiguous way to import this component, which should resolve the error.
