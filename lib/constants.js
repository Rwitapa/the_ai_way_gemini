...
export const courseData = {
  sprint: {
    ...
    keyOutcomes: [
        { icon: 'bolt', text: 'Automate a high-value, repetitive report you manage every week.' },
        { icon: 'git-fork', text: 'Build a live AI workflow that queries, summarizes, and delivers data.' },
        { icon: 'file-text', text: 'Get tangible proof and an Impact Memo to showcase your new skills.' },
    ],
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'code-2', text: 'Master advanced prompt engineering patterns for complex analytical tasks.' },
        { icon: 'award', text: 'Solve 4 real-world business problems using 4 distinct AI techniques.' },
        { icon: 'shield-check', text: 'Design & build trusted, human-in-the-loop workflows for your team.' },
        { icon: 'briefcase', text: 'Create a powerful portfolio project that proves your ROI as an AI leader.' },
    ],
