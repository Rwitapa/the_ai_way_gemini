...
export const courseData = {
  sprint: {
    ...
    keyOutcomes: [
        ...
        { icon: 'code-2', text: 'Master practical prompting for SQL' },
        { icon: 'git-fork', text: 'Build a live AI workflow' },
        { icon: 'file-text', text: 'Get proof of work to show your manager' },
    ],
