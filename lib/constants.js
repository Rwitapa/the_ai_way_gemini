...
export const courseData = {
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'compass', text: "Master analyst-focused prompts for SQL, summaries, anomaly detection, and structured outputs." },
        { icon: 'book', text: 'Learn 4 core AI techniques - Automation, RAG, AI Agents, and Anomaly Detection - and when to apply each.' },
        { icon: 'tool', text: 'Build 4 production-ready projects: Dashboard Narratives, Customer Retention insights, Inventory/Stockout alerts, Marketing Campaign Anomaly tracking. },
