...
export const courseData = {
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'compass', text: "Learn 4 core AI techniques: Automation, RAG, AI Agents, and Anomaly Detection." },
        { icon: 'book', text: 'Build 4 real projects: Dashboard narratives, Customer Retention insights, Inventory Stockout alerts, and Marketing Campaign Anomaly tracking.' },
        { icon: 'tool', text: 'Add human-in-the-loop checks so outputs are accurate and trusted. },
        { icon: 'briefcase', text: 'Create a portfolio that proves impact and positions you as the AI-first analyst in your org.' },
    ],
