...
export const courseData = {
  sprint: {
    ...
    keyOutcomes: [
        { icon: 'bolt', text: 'Get a quick, tangible win. Automate one task you hate.' },
        { icon: 'git-fork', text: 'Leave with one working AI workflow that saves you hours.' },
        { icon: 'file-text', text: 'Learn practical prompting & automation basics.' },
    ],
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'award', text: 'Master AI for analytics and go deep on multiple use cases.' },
        { icon: 'briefcase', text: 'Build a 4-project portfolio to showcase your expertise.' },
        { icon: 'shield-check', text: 'Learn advanced techniques and career branding.' },
    ],
