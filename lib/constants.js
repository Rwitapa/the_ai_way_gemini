...
export const courseData = {
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'compass', text: "Spot why traditional analytics feels painful and how AI actually fixes it." },
        { icon: 'book', text: 'Learn prompt-engineering patterns tailored for business analysts.' },
        { icon: 'tool', text: 'Apply 4 AI solutioning techniques to solve real analytics problems end-to-end.' },
