...
export const courseData = {
  sprint: {
    ...
    whoIsItFor: 'Early-career analysts stuck on repetitive reporting and pressured to “use AI” without guidance, and leaders who want their teams delivering sharper insights. If buzzwords and non-scalable tool demos leave you confused about its practical use, this sprint gives you a fast, no-fluff way to see AI working on your data.',
    keyOutcomes: [
