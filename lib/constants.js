...
export const courseData = {
  sprint: {
    ...
    keyOutcomes: [
        { icon: 'bolt', text: 'Eliminate one repetitive reporting task from your workflow.' },
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'award', text: 'Solve 4 real-world analytics problems using 4 different AI techniques.' },
    ...
    modules: [
        {
          ...
          {
            title: 'Build: Automated Dashboard Narratives (2 hrs)',
          ...
          {
            title: 'Build: Customer Insights with RAG (2 hrs)',
          ...
          {
            title: 'Build: Agentic Workflows for Alerts (2 hrs)',
            summary: 'Problem: Stockouts erode margins. You will build an agentic workflow that monitors inventory and decides when to trigger intelligent alerts.',
          },
          {
            title: 'Build: Anomaly Detection for Campaigns (2 hrs)',
            summary: 'Problem: Campaign data is scattered. You will build a tracker that aggregates multi-source data to flag unusual performance and explain why.',
          },
          {
