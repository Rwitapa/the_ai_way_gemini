...
export const courseData = {
  sprint: {
    ...
    subtitle: 'Ship your first AI reporting workflow in 3 Hours',
    description: 'Stop the weekly grind of manual reporting. This focused, hands-on sprint is the fastest way to get a real win with AI. We\'ll help you identify a high-value repetitive task and build your first live AI workflow to automate it, giving you proof you can show your manager or use in an interview.',
    ...
    keyOutcomes: [
        { icon: 'bolt', text: 'Eliminate one repetitive reporting task you hate.' },
        { icon: 'file-text', text: 'Build a working AI workflow that queries and summarizes your data.' },
        { icon: 'tool', text: 'Leave with proof that AI can save you hours every single week.' },
    ],
  ...
  accelerator: {
    ...
    description: 'This is not another theory-heavy course. The Accelerator is a hands-on playbook for solving real business problems with AI. You\'ll go deep on 4 core analytics challenges—from automating executive summaries to predicting stockouts—and master the specific AI techniques to solve each one. You\'ll leave with a powerful portfolio that positions you as a top-tier, AI-powered analyst.',
    ...
    keyOutcomes: [
        ...
        { icon: 'git-fork', text: 'Design human-in-the-loop workflows that your team can actually trust.' },
        { icon: 'bar-chart', text: 'Package your work into a portfolio to brand yourself as an AI leader.' },
    ],
