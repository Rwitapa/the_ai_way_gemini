...
export const courseData = {
  sprint: {
    ...
    whoIsItFor: 'Beginners who want proof that AI can solve a real problem today.',
    keyOutcomes: [
  ...
  accelerator: {
    ...
    whoIsItFor: 'Analysts ready to master AI workflows and build a career edge.',
    keyOutcomes: [
    ...
    modules: [
      ...
      {
        title: 'Module 3: Prompt Engineering for Analysts',
      ...
      {
        title: 'Module 4: Automated Executive Dashboard Narrative',
      ...
      {
        title: 'Module 5: Customer Retention Insights (RAG)',
      ...
      {
        title: 'Module 6: Inventory & Stockout Alerts',
      ...
      {
        title: 'Module 7: Marketing Campaign Performance Tracker',
      ...
      {
        title: 'Module 8: Human-in-the-Loop Analytics',
      ...
      {
        title: 'Module 9: Career Edge — Becoming the AI-Powered Analyst',
