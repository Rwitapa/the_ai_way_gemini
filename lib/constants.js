...
export const courseData = {
  sprint: {
    ...
    detailedDescription: "Stop the weekly reporting grind. This 3-hour, hands-on sprint is the fastest way to get a real win with AI. We'll help you identify one high-value report and build a live, automated workflow that saves you hours, starting this week.",
    price: '₹349',
    originalPrice: '₹1,249',
  ...
  accelerator: {
    ...
    detailedDescription: "Ready to transition from a report builder to an AI-driven strategist? This immersive guide teaches you to build systems that deliver business answers instantly. You'll master four distinct AI solutioning techniques by applying them to real-world problems, transforming your role and your career.",
    price: '₹4,999',
