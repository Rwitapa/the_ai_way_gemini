...
export const courseData = {
  ...
  accelerator: {
    ...
    whoIsItFor: 'Ambitious analysts who are ready to master multiple AI workflows, build a powerful portfolio, and establish a significant career edge in the industry.',
    keyOutcomes: [
    ...
    modules: [
        {
            ...
            summary: 'Go beyond dashboards to understand why traditional analytics often fails to deliver swift decisions. You\'ll identify a high-impact analytics problem from your own experience to solve.',
          },
          {
          ...
          },
          {
            ...
            summary: 'Stop getting generic results. Master prompt structures for SQL generation, anomaly detection, and structured summaries to build your personal analytics prompt library.',
          },
          {
            title: 'Module 4: Project 1 - Automated Dashboard Narratives',
            summary: 'Problem: Leaders see numbers but still ask, “So what?” Build a system that automatically pulls dashboard metrics and generates executive-ready commentary with context.',
          },
          {
