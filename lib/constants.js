...
export const courseData = {
  sprint: {
    ...
    keyOutcomes: [
        { icon: 'tool', text: 'Eliminate one repetitive reporting task from your workflow.' },
        { icon: 'git-fork', text: 'Build a working AI workflow that queries and summarizes your data.' },
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'rocket', text: 'Solve 4 real-world analytics problems using 4 different AI techniques.' },
