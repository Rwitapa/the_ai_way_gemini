...
export const courseData = {
  sprint: {
    ...
    whoIsItFor: 'Early-career analysts stuck on repetitive reports and pressured to “use AI” without guidance - often overwhelmed by creators throwing around AI buzzwords and showcasing non-scalable tools. If you want a quick, practical win - not theory or fluff - you’ll build a proof-of-concept AI workflow that saves hours each week and proves to your manager that you can deliver insights leaders act on. It’s also for managers who want their teams to move from data dumps to real insights.',
    keyOutcomes: [
