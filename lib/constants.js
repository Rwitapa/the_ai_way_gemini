...
export const personas = [
    {
      icon: 'user',
      text: 'an Early-career Analyst stuck in reporting instead of solving problems.'
    },
    {
      icon: 'book',
      text: 'a BI/Product/Data analyst drowning in tools but missing clear answers.'
    },
    {
      icon: 'briefcase',
      text: 'a Manager who needs faster, sharper decisions from your team.'
    },
    {
      icon: 'user-check',
      text: 'a Professional aiming for promotions, visibility, and influence.'
    }
];
