...
export const courseData = {
  sprint: {
    ...
    whoIsItFor: 'Beginners who want a tangible proof-of-concept for how AI can solve a real problem.',
    keyOutcomes: [
  ...
  accelerator: {
    ...
    whoIsItFor: 'Ambitious analysts ready to master AI workflows, build a powerful portfolio, and establish a significant career edge.',
    keyOutcomes: [
