// rwitapa/the_ai_way_gemini/the_ai_way_gemini-staging/lib/constants.js
...
/**
 * Generates sprint dates dynamically for a given period.
 * Sprints are on Mondays, Wednesdays, and Fridays.
...
/**
 * Generates accelerator dates dynamically for a given period.
 * Accelerator cohorts run on alternate weekends (odd calendar weeks).
 * @param {Date} startDate - The date to start generating from.
 * @param {number} yearsIntoFuture - How many years of dates to generate.
