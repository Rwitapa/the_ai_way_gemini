...
export const courseData = {
  sprint: {
    ...
    whoIsItFor: 'Early-career analysts stuck running the same reports and pressured to "use AI" without clear guidance, and for leaders who want their teams delivering actionable insights. If you’re surrounded by AI buzzwords or flashy tool demos that don’t scale, and are unsure of their practical use, this sprint gives you a quick, no-fluff win: build a proof-of-concept AI workflow that saves hours each week and shows your manager you can deliver insights leaders act on.',
    keyOutcomes: [
