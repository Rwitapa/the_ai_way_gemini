...
export const courseData = {
  ...
  accelerator: {
    ...
    detailedDescription: "Across one weekend, you’ll go beyond dashboards to build workflows that think, act, and deliver insights. You’ll spot where traditional analytics breaks, then apply AI techniques that scale, without the buzzwords. Together, we’ll build four production-ready projects tied to real business pain points, with human-in-the-loop checks for trust. By the end, you’ll ship working systems in n8n and leave with a portfolio that proves you can drive AI adoption, not just keep up with it.",
    price: '₹4,999',
    ...
    keyOutcomes: [
        { icon: 'compass', text: "Master prompts for SQL, summaries and structured outputs." },
    ...
    modules: [
        {
            ...
            summary: '(~1 hr) See why traditional analytics feels slow, manual, and disconnected. Learn to move past surface-level dashboards and identify real business problems that AI can actually fix.',
          },
          {
            title: 'Module 2: Foundations - AI Hype vs. Reality',
            summary: '(~1 hr) Cut through buzzwords and tool demos that don’t scale. Learn what LLMs can and cannot do for analytics, and leave with a clear checklist for spotting high-value AI use cases.',
          },
          {
            title: 'Module 3: Foundations - Prompt Engineering for Analysts',
            summary: '(~2 hrs) Stop getting generic results. Master prompt structures for SQL, summaries, anomaly detection, and structured outputs, and build your personal prompt library tailored for analytics.',
          },
          {
            title: 'Module 4: Project 1 - Automated Dashboard Narratives',
            summary: '(~2 hrs) Dashboards give numbers, but leaders ask “So what?” Build a workflow that pulls metrics and automatically generates executive-ready commentary with context and recommendations.',
          },
          {
            title: 'Module 5: Project 2 - Customer Insights with RAG',
            summary: '(~2 hrs) Churn drivers hide in messy tickets and surveys. Use Retrieval-Augmented Generation (RAG) to surface insights from unstructured data and answer “Why are customers leaving?” with evidence.',
          },
          {
            title: 'Module 6: Project 3 - Agentic Workflows for Alerts',
            summary: '(~2 hrs) Stockouts and excess inventory kill margins. Build an agentic workflow that monitors thresholds in real-time and triggers intelligent alerts when action is needed.',
          },
          {
            title: 'Module 7: Project 4 - Anomaly Detection for Campaigns',
            summary: '(~2 hrs) Marketing data lives across Ads, CRM, and Email. Create a tracker that aggregates sources, detects unusual campaign performance, and explains the “why” behind spikes or dips.',
          },
          {
            title: 'Module 8: Advanced Skills - Human-in-the-Loop',
            summary: '(~2 hrs) AI without checks can’t be trusted. Learn how to design workflows with review gates, analyst approvals, and validation loops, and leave with a reusable template.,
          },
          {
            title: 'Module 9: Career Skills - Portfolio & Branding',
            summary: '(~2 hrs) Learn to showcase yourself as the one driving AI adoption. You\'ll translate your capstone project into a portfolio-ready case study and a LinkedIn post draft.',
          },
    ],
  },
};
