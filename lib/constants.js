...
export const courseData = {
  sprint: {
    ...
    detailedDescription: "Ship a quick, real win. In three hours, you’ll pick one repetitive report, learn the exact prompt patterns (Natural Language → SQL, structured summaries, validation), and build a working AI workflow that queries your data and writes the narrative for you. We keep it hands-on and simple - n8n + an LLM + your database (Postgres/BigQuery) - so you leave with a proof-of-concept that saves hours every week and a clear demo your manager can act on.",
    price: '₹349',
    originalPrice: '₹1,249',
    ...
    whoIsItFor: 'Early-career analysts who are stuck cranking the same weekly reports, drowning in tools, and under pressure to “use AI” without real guidance. If you want a quick, practical win - not theory or tool show-offs - this live sprint gives you a proof-of-concept AI workflow that actually runs on your data, saves hours every week, and shows your manager you can deliver insights leaders act on. It’s also right for managers who want the team moving from exports to answers, and for ambitious pros chasing visibility without wading through jargon.',
    keyOutcomes: [
        { icon: 'bolt', text: 'Eliminate one repetitive reporting task from your workflow.' },
        { icon: 'code-2', text: 'Learn practical prompting techniques for analysts - including SQL generation, summaries, and structured outputs.' },
        { icon: 'git-fork', text: 'Build a working AI workflow that queries and summarizes your data.' },
        { icon: 'award', text: 'Leave with proof that AI can save you hours every single week - and the confidence to explore more advanced use cases.' },
    ],
    tools: ['n8n', 'OpenAI LLM', 'Postgres/BigQuery'],
    modules: [
      {
        title: 'Module 1: Why Reporting is Broken',
        summary: 'Understand why manual reporting slows down decisions and identify the perfect recurring report from your own work to automate for an immediate impact.',
      },
      {
        title: 'Module 2: Prompting for Reporting',
        summary: 'Learn practical prompt structures to get reliable SQL, structured summaries, and validated outputs from language models, and leave with a starter prompt library.',
      },
      {
        title: 'Module 3: Build Your First AI Workflow',
        summary: 'Get hands-on and automate your chosen report from end-to-end. You will connect to a data source, automate the query, and generate an analyst-ready summary with AI.',
      },
    ],
  },
  accelerator: {
    ...
    detailedDescription: "Go from “numbers on a dashboard” to workflows that think and act. Across a weekend, we build four production-ready systems together: executive dashboard narratives, retention insights with RAG, inventory/stockout agents, and marketing anomaly tracking - each with human-in-the-loop checks your team can trust. You’ll master analyst-friendly prompt patterns, wire them up in n8n with the right data stores, and package everything into a clean portfolio that proves impact and positions you as the AI-first analyst on your team.",
    price: '₹4,999',
    ...
    whoIsItFor: 'Analysts and data leads who are done with fluff and too many AI tools and buzzwords. You just want to learn work that ships and helps you stay relevant. We teach by building live - real problems, simple steps, and clear checkpoints so your team can trust the output. In the 16-Hour Superstar Accelerator, you’ll build usable workflows (AI agents, RAG, anomaly detection, and human-in-the-loop AI automation) and turn them into a clean portfolio that proves impact and helps you lead AI on your team.',
    keyOutcomes: [
        { icon: 'compass', text: "Spot why traditional analytics feels painful and how AI actually fixes it. Also, learn prompt-engineering patterns tailored for analysts." },
        { icon: 'book', text: 'Apply 4 AI solutioning techniques (AI Automation, RAG, AI Agents, Anomaly Detection) to solve real analytics problems end-to-end.' },
        { icon: 'tool', text: 'Create projects to automate Executive Dashboard Narratives, find Customer Retention Insights, pre-empt Inventory & Stockout Alerts and track Marketing Campaign Performance' },
        { icon: 'briefcase', text: 'Build trusted human-in-the-loop workflows and package them into a standout AI analyst portfolio.' },
    ],
