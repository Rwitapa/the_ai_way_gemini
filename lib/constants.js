...
export const courseData = {
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'award', text: 'Solve 4 real-world business problems' },
        { icon: 'tool', text: 'Master 4 advanced AI techniques (RAG, Agents)' },
        { icon: 'shield-check', text: 'Design trusted, human-in-the-loop systems' },
        { icon: 'briefcase', text: 'Build a powerful portfolio project' },
        { icon: 'rocket', text: 'Learn career branding & positioning' },
    ],
