...
export const courseData = {
  sprint: {
    ...
    keyOutcomes: [
        ...
        { icon: 'edit-3', text: 'Learn practical prompting techniques for analysts - including SQL generation, summaries, and structured outputs.' },
        { icon: 'git-merge', text: 'Build a working AI workflow that queries and summarizes your data.' },
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'eye', text: "Spot why traditional analytics feels painful and how AI actually fixes it." },
        { icon: 'edit-3', text: 'Learn prompt-engineering patterns tailored for business analysts.' },
