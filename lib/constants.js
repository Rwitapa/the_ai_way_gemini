...
export const courseData = {
  sprint: {
    ...
    subtitle: 'Automate Your First Report & Win Back Hours',
    description: 'Stop spending hours on manual reports. This focused, hands-on sprint is the fastest way to solve a real analyst problem with AI. You\'ll identify a high-value repetitive task and build your first live AI workflow to automate it, giving you a tangible win and the confidence to tackle more.',
    detailedDescription: "Tired of the endless reporting grind? This intensive sprint is designed to solve one of your biggest time-sinks. In just three hours, you'll go from manual data pulls to a fully automated workflow that queries data, generates a summary, and gives you back valuable hours every single week.",
    price: '₹349',
    originalPrice: '₹1,249',
    ...
    keyOutcomes: [
        { icon: 'zap', text: 'Eliminate one repetitive reporting task from your workflow.' },
        { icon: 'cpu', text: 'Build a working AI workflow that queries and summarizes your data.' },
        { icon: 'file-text', text: 'Leave with proof that AI can save you hours every single week.' },
    ],
    tools: ['n8n', 'OpenAI LLM', 'Postgres/BigQuery'],
    modules: [
      {
        title: 'Module 1: Why Reporting is Broken (30 min)',
        summary: 'Pinpoint the #1 bottleneck in your current workflow and choose a high-value recurring report to automate by the end of the session.',
      },
      {
        title: 'Module 2: Prompting for Reporting (30 min)',
        summary: 'Learn analyst-specific prompt structures for converting natural language to SQL, creating structured summaries, and validating outputs to avoid messy results.',
      },
      {
        title: 'Module 3: Build Your First AI Workflow (2 hrs)',
        summary: 'Get hands-on and automate your chosen report from end-to-end. You will connect to a data source (Postgres/BigQuery), automate the query, and generate an analyst-ready summary with AI.',
      },
    ],
  },
  accelerator: {
    ...
    description: 'This is not another theory-heavy course. The Accelerator is a deep, hands-on playbook for solving real-world business problems with AI. You will learn to design, build, and deploy end-to-end agentic systems that analyze data, deliver insights, and drive decisions, leaving with a portfolio that showcases your expertise.',
    detailedDescription: "Ready to transition from a report builder to an AI-driven strategist? The Accelerator is your immersive guide to building systems that deliver business answers instantly. You'll master four distinct AI solutioning techniques by applying them to real-world problems like churn analysis, inventory alerts, and marketing performance, transforming your role and your career.",
    price: '₹4,999',
    ...
    keyOutcomes: [
        { icon: 'box', text: 'Solve 4 real-world analytics problems using 4 different AI techniques.' },
        { icon: 'shield-check', text: 'Design human-in-the-loop workflows that your team can actually trust.' },
        { icon: 'briefcase', text: 'Package your work into a portfolio to brand yourself as an AI-powered analyst.' },
    ],
    tools: ['n8n', 'OpenAI LLM', 'Qdrant/Pinecone', 'Python', 'Looker/Tableau Connectors'],
    modules: [
      {
        title: 'Module 1: Analytics is Broken (1 hr)',
      ...
      {
        title: 'Module 2: AI Hype vs. Reality (1 hr)',
        summary: 'Cut through the noise of flashy AI tools. Get a practical framework for when to build your own flexible workflows versus using off-the-shelf products.',
      },
      {
        title: 'Module 3: Prompt Engineering for Analysts (2 hrs)',
        summary: 'Master prompt structures for complex analytical tasks including SQL generation, anomaly detection, narrative summaries, and structured data extraction.',
      },
      {
        title: 'Module 4: Automated Executive Dashboard Narrative (2 hrs)',
        summary: 'Build a system that automatically pulls dashboard metrics and generates executive-ready commentary with context and recommendations.',
      },
      {
        title: 'Module 5: Customer Retention Insights (RAG) (2 hrs)',
        summary: 'Use Retrieval-Augmented Generation (RAG) to build a workflow that analyzes unstructured data (like support tickets or surveys) to answer "Why are our customers leaving?"',
      },
      {
        title: 'Module 6: Inventory & Stockout Alerts (2 hrs)',
        summary: 'Create an agentic workflow that monitors inventory data, decides when to act based on thresholds, and automatically triggers stockout alerts.',
      },
      {
        title: 'Module 7: Marketing Campaign Performance Tracker (2 hrs)',
        summary: 'Build a system that aggregates data from multiple marketing platforms (Ads, CRM) to detect performance anomalies and explain the likely cause.',
      },
      {
        title: 'Module 8: Human-in-the-Loop Analytics (2 hrs)',
        summary: 'Learn to design trustworthy AI systems by building checkpoints, analyst approval steps, and validation loops into your workflows.',
      },
      {
        title: 'Module 9: Career Edge — Becoming the AI-Powered Analyst (2 hrs)',
        summary: 'Translate your project into a compelling, portfolio-ready case study and a LinkedIn post that showcases you as an AI-powered analyst.',
      },
    ],
  },
};
...
export const getNextSprintDates = (startDate, monthsIntoFuture = 3) => {
    ...
    while (currentDate <= endDate) {
        // Use a compatible, string-based format to get the weekday in the correct timezone
