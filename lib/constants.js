...
export const courseData = {
  sprint: {
    ...
    detailedDescription: "In three hours, you'll pick one repetitive report and turn it into an AI workflow that queries your data and writes the narrative for you. Learn the key prompt patterns (NL → SQL, summaries, validation), wire it up in n8n with your database, and leave with a proof-of-concept that saves hours weekly and a clear demo your manager can act on.",
    price: '₹349',
    originalPrice: '₹1,249',
    ...
    whoIsItFor: 'Early-career analysts stuck running the same reports and pressured to "use AI" without clear guidance, and for leaders who want their teams delivering sharper, actionable insights. If you’re surrounded by AI buzzwords or flashy tool demos that don’t scale, and are unsure of their practical application, this sprint gives you a quick, no-fluff win: build a proof-of-concept AI workflow that saves hours each week and shows your manager you can deliver insights leaders act on.',
    keyOutcomes: [
        { icon: 'bolt', text: 'Identify one repetitive report you run every week and replace it with an automated AI workflow' },
        { icon: 'code-2', text: 'Learn analyst-ready prompting patterns: Natural Language → SQL with constraints, clean summaries with context, and structured outputs you can reuse.' },
        { icon: 'git-fork', text: 'Build a working AI workflow in n8n that connects to your database, runs the query, and produces an “analyst-ready” narrative.' },
        { icon: 'award', text: 'Leave with a proof-of-concept that consistently saves hours each week, plus the confidence to explore more advanced use cases.' },
    ],
  ...
  accelerator: {
    ...
    detailedDescription: "Go from “numbers on a dashboard” to workflows that think and act. In one weekend, learn to solve four production-ready business problems - Executive narratives, Customer Retention insights, Inventory / Stockout AI agents, and marketing anomaly tracking - with human-in-the-loop checks. Master analyst-friendly prompting, ship usable systems in n8n, and leave with a portfolio that proves impact and positions you as the AI-first analyst on your team.",
    price: '₹4,999',
    ...
    whoIsItFor: 'For analysts and data leads stitching data from everywhere yet getting answers that are late, shallow, or untrusted. If dashboards and one-off automations leave gaps and no clear so-what, spend a weekend building four end-to-end systems with human-in-the-loop checks. You’ll use four AI techniques - automation, RAG, agents, anomaly detection - and leave with reusable patterns, working workflows, and a portfolio that proves impact and helps you lead AI on your team.',
    keyOutcomes: [
        { icon: 'compass', text: "Spot why traditional analytics feels painful and how AI fixes it." },
        ...
        { icon: 'briefcase', text: 'Build trusted human-in-the-loop workflows, learn prompt-engineering patterns tailored for analysts and package them into a standout AI analyst portfolio.' },
    ],
