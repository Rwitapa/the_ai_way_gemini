...
export const courseData = {
  sprint: {
    ...
    keyOutcomes: [
        { icon: 'bolt', text: 'Automate one repetitive reporting task.' },
        { icon: 'git-fork', text: 'Build a live AI workflow that queries & summarizes data.' },
        { icon: 'file-text', text: 'Get proof that AI can save you hours weekly.' },
    ],
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'award', text: 'Solve 4 real-world problems with 4 AI techniques.' },
        { icon: 'shield-check', text: 'Design trusted, human-in-the-loop workflows.' },
        { icon: 'briefcase', text: 'Build a portfolio that brands you as an AI leader.' },
    ],
