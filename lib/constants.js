...
export const courseData = {
  sprint: {
    ...
    keyOutcomes: [
        { icon: 'bolt', text: 'Win back your week by automating a repetitive reporting task.' },
        { icon: 'code-2', text: 'Learn practical prompting to get reliable summaries & SQL.' },
        { icon: 'git-fork', text: 'Build and deploy your first live AI workflow in just 3 hours.' },
        { icon: 'file-text', text: 'Create a proof-of-work memo to showcase your new skills.' },
    ],
  ...
  accelerator: {
    ...
    keyOutcomes: [
        { icon: 'award', text: 'Go Beyond Dashboards to solve 4 real business problems.' },
        { icon: 'tool', text: 'Master 4 advanced AI techniques like RAG & Agentic Workflows.' },
        { icon: 'shield-check', text: 'Build trusted, human-in-the-loop systems that leaders will actually use.' },
        { icon: 'briefcase', text: 'Create a powerful portfolio that proves your impact and ROI.' },
        { icon: 'rocket', text: 'Learn career branding to position yourself as an AI leader.' },
    ],
